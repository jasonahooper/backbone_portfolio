...
CREATE TABLE "users" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "first_name" varchar(255), "last_name" varchar(255), "bio" text, "mission" text, "image_url" varchar(255), "created_at" datetime, "updated_at" datetime, "facebook_id" varchar(255), "facebook_access_token" varchar(255));
...
INSERT INTO schema_migrations (version) VALUES ('20131204154457');
